...
const EmailBox = () => (
  <div className="flex items-center justify-between gap-y-5 rounded-[var(--rounded-2xl)] bg-bright px-14 py-12 2xl:px-10 2xl:py-8 xl:flex-col xl:items-stretch xl:!px-8 xl:!py-6">
